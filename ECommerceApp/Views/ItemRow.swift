...
struct ItemRow_Previews: PreviewProvider {
    static var previews: some View {
        ItemRow(cloth: Cloth(name: "Printed Long Top", description: "Red floral print long top, has a round collar, full sleeves and available in different sizes for women.", price: 2399, imageURL: "redDress", company: "Rain & Rainbow", color: "Red", size: "S", discount: 40, rating: 4, type: "sale", isFavorite: false))
    }
}
