...
struct ItemDetailsView_Previews: PreviewProvider {
    static var previews: some View {
        ItemDetailsView(show: .constant(false), cloth: Cloth(name: "Women Printed Flare Dress", description: "Green printed woven fit and flare dress, has a notched lapel collar and sleevesless.", price: 2149, imageURL: "greenDress", company: "Chemistry Edition", color: "Green", size: "L", discount: 40, rating: 4, type: "sale", isFavorite: false))
    }
}
